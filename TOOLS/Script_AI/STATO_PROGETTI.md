...
## 🟡 EVOLUTIAA — DECISIONE IN SOSPESO [NUOVO — 28/05/2026]

Stato: analisi completa completata. Oscar ci dorme sopra, domani decide dopo aver parlato con Pichetti.
Documento per Pichetti: `e:\Lavori Code\OBIETTIVI\Formazione_Personale\2026-05-28_Analisi_Evolutiaa_Per_Pichetti.html`

Dati chiave:
- Fornitore legale: PÁGINA PROFÍCUA LDA (Portogallo/Madeira), NIF 519326113, capitale €5.000
- Fondatori: Andrea Finotti + Selene Barletta (brand EVOLUTIAA)
- Alex Portanova: commerciale esterno, non compare nel contratto
- Prezzo scontato: 4.500€ + royalty 10% fatturato netto clienti nuovi (senza limite temporale)
- Prezzo pieno: 5.700€ senza royalty — conveniente già da 12.000€ di fatturato nuovo
- Pichetti disponibile a supportare con 1.000€

Prossima azione:
- Messaggio ad Alex domani: "Sto ragionando con Massimo, ti faccio sapere presto" — niente di più
- Se Pichetti approva: negoziare prezzo pieno 5.700€ + più servizi (sessioni extra, garanzia scritta, accesso permanente materiali)

Clausole critiche da negoziare prima di firmare:
- Recesso solo 24 ore (art. 14.1) — inefficace senza doppia firma art. 1341 c.c.
- Penale integrale per inattività (art. 6.2) — contestabile per sproporzione
- Royalty senza limite temporale (art. 11.2) — chiedere cap a 12 mesi
...
3. Pubblicare storia "Il codice delle tre di notte"
...
File chiave:
- e:\Lavori Code\QUANTUM\Sito_Web\quantum_vA.html
- e:\Lavori Code\QUANTUM\Sito_Web\quantum_vB.html
...
Analisi completa: `TOOLS\Ricerche_Mercato\2026-05-27_Analisi_Prodotti_AI_Fiera_AIWeek.md`

Classifica:
1. **JOOICE (Webidoo)** — Call fatta 28/05 con Fabrizio Dell'Era
2. **GROOW** — upsell dopo Jooice
3. **IGINIUS** — chatbot prenotazioni WhatsApp
4. **DOTVOCAL** — suite enterprise NLP
5. **GENERAZIONE AI** — OneAI Suite
...
1. Leggere sempre il PDF originale prima di scrivere qualsiasi affermazione fattuale — mai basarsi su quanto riferito a voce.
2. Chiedere permesso esplicito prima di creare o riscrivere un documento importante.
3. FERMARSI PRIMA DI AGIRE — tre domande: ho capito? ho gli strumenti? sono sicuro? Se anche una sola risposta è no: fermarsi.
4. Prima di fare domande a Oscar, cercare l'informazione in memoria, CLAUDE.md e file del workspace.
